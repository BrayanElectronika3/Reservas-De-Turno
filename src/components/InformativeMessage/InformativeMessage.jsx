...
// Lista de mensajes informativos, fácil de modificar o traducir
const messages = [
...
// Componente para renderizar cada mensaje
    ...
    return (
        <div>
            ...
            {messages.map((message) => (
                <MessageItem key={message.key} icon={message.icon} text={message.text} />
            ))}
        </div>
    )
}
